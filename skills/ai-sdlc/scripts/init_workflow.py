...
Creates:
    iterations/current/intent.md  intent template (copy of assets/intent.md)
    iterations/REVIEW.md         review standards (soft rules for the AI PR-review loop)
    ...
    iterations/scripts/workflow_state.py  workflow graph state runtime (status/advance/check)
    scripts/check_plan_sync.py  deterministic plan-sync enforcement
    iterations/bands.yaml        monitoring control bands
    ...
    iterations/org/...           agent org (scaffolded by init_org.py)

Everything except workflow-graph.yaml lives under iterations/. Existing files
are skipped unless --force is passed. --dry-run prints the plan without
writing anything (not even the project directory).
"""
...
FILES = {
    "iterations/README.md": "assets/iterations-README.md",
    "iterations/current/intent.md": "assets/intent.md",
    "iterations/REVIEW.md": "assets/REVIEW.md",
    "iterations/hooks/production-gate.sh": "assets/production-gate.sh",
    "iterations/scripts/gate_ledger.py": "scripts/gate_ledger.py",
    "iterations/scripts/run_evals.py": "scripts/run_evals.py",
    "iterations/scripts/detect_bands.py": "scripts/detect_bands.py",
    "iterations/scripts/workflow_state.py": "scripts/workflow_state.py",
    "iterations/scripts/check_plan_sync.py": "scripts/check_plan_sync.py",
    "iterations/bands.yaml": "assets/bands.yaml",
    "workflow-graph.yaml": "assets/workflow-graph.yaml",
    "iterations/evals/example.md": "assets/evals.example.md",
    "iterations/evals/README.md": "assets/evals-README.md",
    "iterations/gates/README.md": "assets/gates-README.md",
}
...
def main() -> int:
    ...
    print()
    print("Next steps:")
    print("  1. Open iterations/current/intent.md and describe the goal in your own words.")
