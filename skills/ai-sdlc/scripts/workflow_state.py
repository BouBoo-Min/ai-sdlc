...
Usage:
    workflow_state.py status [--graph workflow-graph.yaml]
                             [--ledger iterations/gates/ledger.jsonl] [--json]
    ...
    workflow_state.py check [--graph workflow-graph.yaml]
                            [--ledger iterations/gates/ledger.jsonl] [--strict]
    workflow_state.py preflight [--graph workflow-graph.yaml]
                                [--ledger iterations/gates/ledger.jsonl]   (hook, stdin JSON)
...
DEFAULT_LEDGER = "iterations/gates/ledger.jsonl"
