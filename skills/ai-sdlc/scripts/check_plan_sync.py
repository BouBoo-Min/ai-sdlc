...
Usage:
    check_plan_sync.py --base <rev> --head <rev>
                       ...
                       [--ledger iterations/gates/ledger.jsonl]
                       [--ignore <glob>]... [--two-dot]
...
PROCESS_ENTRIES = (
    "iterations/",
    "iterations/REVIEW.md",
    "workflow-graph.yaml",
    "gates/",
    "iterations/org/",
    "evals/",
    "iterations/bands.yaml",
    "hooks/",
    "docs/",
    ".github/",
    "CHANGELOG.md",
...
def _show(repo: Path, spec: str) -> tuple[bool, str]:
    return _git(repo, ["show", f"{spec}:iterations/current/plan.md"])
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--ledger", default=None, help="iterations/gates/ledger.jsonl when ledger-gating is wanted")
