...
format GitHub intake already produces under iterations/org/intake/, so the product
...
Usage:
    intake.py add --source form|email --record-id <id> \\
        ...
        [--output iterations/org/intake/<source>/] [--dry-run]
...
INTAKE_ROOT = PROJECT_ROOT / "iterations" / "org" / "intake"
