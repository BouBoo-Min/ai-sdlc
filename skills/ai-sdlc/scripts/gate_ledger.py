...
Usage:
    gate_ledger.py --ledger iterations/gates/ledger.jsonl record --gate <gate>
        --artifact <name> [--commit <sha>] --approver <who>
        --evidence <ticket-or-link> [--expires-at ISO-8601]
        [--decision approved|rejected] [--id <id>]
    gate_ledger.py --ledger iterations/gates/ledger.jsonl list [--gate <gate>]
    gate_ledger.py --ledger iterations/gates/ledger.jsonl verify --record <id>
...
LEDGER_DEFAULT = "iterations/gates/ledger.jsonl"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--ledger", default=LEDGER_DEFAULT, help="ledger file (default: iterations/gates/ledger.jsonl)")
