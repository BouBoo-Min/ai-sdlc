...
<!-- Convention: iterations/current/ holds the LIVE iteration bundle
     (intent.md + spec.md + plan.md). When the iteration's PR merges, rename
     the whole folder to iterations/NNN-<short-sha>-<slug>/ and write the new
     draft here — the workflow graph, check, and preflight all track this
     fixed path. -->
