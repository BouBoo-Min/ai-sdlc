...
git add iterations/gates/ledger.jsonl && git commit -m "gates: record release authorization REL-…"
```
...
```bash
python3 iterations/scripts/gate_ledger.py verify --record release_authorization-001 \
