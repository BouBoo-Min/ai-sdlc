...
- `iterations/org/intake/github/` — issues pulled by `scripts/sync_issues.py pull`
- `iterations/org/intake/forms/` — user feedback from app forms
- `iterations/org/intake/email/` — feedback and complaints from email
...
- Propose ideas from product context and user signals, as long as they are
  grounded in evidence and recorded in `iterations/org/intake/`.
